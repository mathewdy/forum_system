                    ...
                    <div class="container mb-5">
                        <div class="card bg-dark px-5 py-4">
                            <div class="d-flex flex-row align-items-center">
                                <img src="<?php echo "../users/uploads/" . $row_topic ['image'] ?>" alt="image user" style="height:50px; width: 50px; border-radius: 50%; padding: 0; margin: 0;">
                ...
                foreach($run_threads as $row_threads){
                    ...
                    <section class="container-fluid d-flex">
                        ...
                        <div class="card bg-dark px-3 py-3 mx-3 w-100" style="border-left: 3px solid #990000;">
                            ...
                            <!--edit comment -->
                            <!-- <a href="edit-comment.php?comment_id=<?php echo $row_threads['comment_id']?>" style='color: rgba(255,255,255,0.6);'>Edit</a> -->
                                <span class='vr mx-2' style='border:1px solid rgba(255,255,255,0.6);'></span>
                            <!----delete--->

                                <a href="delete-comment.php?comment_id=<?php echo $row_threads['comment_id']?>" style='color: rgba(255,255,255,0.6);'>Delete</a>    
                            </span>
                        </div>
                    </section>
