  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav ms-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="users/home.php">Forum</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="users/registration.php">Sign up</a>
        </li>
      </ul>
    </div>
  </div>
        ...
        <div class="container-fluid">
            <div class="row d-flex align-items-center justify-content-center">
                <span class="card bg-dark p-5 col-lg-5 m-5">
                    ...
                    Helluva Promotion is a Role-playing, 3D Puzzle adventure, game where you play as 
    ...
    <div id="about">
        <section>
            <div class="bg-dark text-center p-5">
                ...
                <h1 style="font-size:3em; padding:0; color:rgba(255,255,255,0.6);">Members</h1>
                <span class="d-flex justify-content-center row">
                    <span class="col-xxl-4 col-sm-12 p-4">
